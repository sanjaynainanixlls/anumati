...
include dirname(dirname(__FILE__)) . '/sewa.ssdndeepu.com/action/globalCompletedRegistrationsAction.php';
$userDataHandlerObj = new userDataHandler();
$data = $userDataHandlerObj->getGlobalCompletedRegistrations();
?>
<!DOCTYPE html>
<html lang="en">
