...
include dirname(dirname(__FILE__)) . '/sewa.ssdndeepu.com/action/completedStatusAction.php';
$userDataHandlerObj = new userDataHandler();
$data = $userDataHandlerObj->getCompletedStatus();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        <title>Completed Registrations</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Completed Registrations from <?php echo $_SESSION['user'] ?>
                            </h1>
