...
include dirname(dirname(__FILE__)) . '/sewa.ssdndeepu.com/action/pendingStatusAction.php';
$userDataHandlerObj = new userDataHandler();
$data = $userDataHandlerObj->getPendingStatus();
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Pending Registrations from <?php echo $_SESSION['user'] ?>
                            </h1>
